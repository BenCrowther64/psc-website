...
<template>
    <TopBannerImage text = "PROJECT MANAGEMENT"></TopBannerImage>

    <div class = bs-heading>
      <h1>
        WITH YEARS OF EXPERTISE ACROSS MULTIPLE INDUSTRIES AND PROJECT SIZES, OUR HIGHLY-SKILLED PROJECT MANAGEMENT TEAM PROVIDES THOROUGH PLANNING, EXECUTION, AND MONITORING TO 
        ENSURE THE SUCCESSFUL DELIVERY OF YOUR PROJECT ON TIME, WITHIN BUDGET, AND TO YOUR SATISFACTION.
      </h1>
    </div>
...
.bs-offering:hover {
    background-color: var(--psc-dark-blue);
